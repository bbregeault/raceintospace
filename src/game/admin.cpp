        ...
        if ((sc == 0 || sc == 2) && !savegames.empty() && ((x >= 209 && y >= 50 && x <= 278 && y <= 58 && mousebuttons > 0)
            ...
            if (i == 1) {
                ...
                if (savegames.empty()) {
                    ...
                    draw_string_keyhint(233, 56, "LOAD", 0, 9);
                    draw_string_keyhint(226, 98, "DELETE", 0, 9);
                }
                else {
                    FileText(&savegames[now].Name[0]);
                }
...
void DrawTimeCapsule(int display)
{
    ...
    display::graphics.setForegroundColor(1);
    draw_string_keyhint(233, 56, "LOAD", 0, 9);
    draw_string_keyhint(233, 70, "SAVE", 0, 9);
    draw_string_keyhint(221, 84, "MAIL SAVE", 0, 9);
    draw_string_keyhint(227, 98, "DELETE", 0, 9);
    draw_string_keyhint(233, 112, "PLAY", 0, 9);
    draw_string_keyhint(234, 126, "QUIT", 0, 9);
}
...
int FutureCheck(char plr, char type)
{
    ...
    IOBox(217, 17, 264, 29);
    display::graphics.setForegroundColor(9);
    draw_string_keyhint(231, 25, "EXIT", 0, 11);
    display::graphics.setForegroundColor(11);
